...
-(void)createUI {
    ...
    _videoName.frame = CGRectMake(90, 10, QM_kScreenWidth-150, 20);
    ...
    _videoSize.frame = CGRectMake(90, 30, QM_kScreenWidth-150, 20);
    ...
    _videoDate.frame = CGRectMake(90, 50, QM_kScreenWidth-150, 20);
    ...
    self.pickedItemImageView.frame = CGRectMake(QM_kScreenWidth-50, 25, 30, 30);
